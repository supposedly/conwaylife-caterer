...
@bot.command(description="Produce an invite link for this bot. Not in its own cog bc it's easier to have it in the same file as the oauth var (read: im lazy)")
